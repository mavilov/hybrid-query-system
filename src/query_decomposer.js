...
- IF the query requires SQL results (e.g., finding the CVE for a package) to inform a VECTOR search
 (e.g., finding the detailed advisory for that CVE), the 'type' is HYBRID.
...
Required JSON Schema:
{
    ...
    "sqlQuery": "STRING (required if type is SQL or HYBRID. Use JOINs and WHERE clauses to retrieve all related vulnerability data for a package name.)",
